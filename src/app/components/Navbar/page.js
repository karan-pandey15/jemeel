      ...
      <div className="bg-white shadow-md py-2 relative">
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-4">
            ...
            <Link href="pages/contact" className="text-gray-600 hover:text-black text-sm">CONTACT US</Link>
            <Link href="pages/about" className="text-gray-600 hover:text-black text-sm">ABOUT US</Link>
          </div>
            ...
            {isSearchOpen ? (
              <div className="relative flex items-center">
                <input
                  ...
                  autoFocus
                />
                <button onClick={handleSearchClose} className="absolute right-2 text-gray-500">
                  <FiX className="w-5 h-5" />
                </button>
              </div>
            ) : (
              <Link href="/" className="tracking-wide text-black-200 font-extrabold">JEMEL</Link>
            )}
          </div>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex justify-end">
          <div className="w-64 bg-white shadow-md h-full p-5 space-y-4 text-gray-700">
            ...
            <Link href="/" className="block text-lg">HOME PAGE</Link>
            <Link href="pages/contact" className="block text-lg">CONTACT US</Link>
            <Link href="pages/about" className="block text-lg">ABOUT</Link>
            <Link href="/pages/ProductPage" className="block text-lg">OUR PRODUCTS</Link>
          </div>
        </div>
      )}
    </div>
